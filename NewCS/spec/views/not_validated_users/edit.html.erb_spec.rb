...
describe "not_validated_users/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit not_validated_user form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => not_validated_users_path(@not_validated_user), :method => "post" do
